...
//    Route::get('login/{provider}/callback', [SocialController::class,'callback'])->where('provider','facebook|twitter|google');
    ...
    Route::middleware(['loginCheck'])->group(function () {
        ...
        Route::post('delete-media', [MediaController::class, 'deleteSelectedMedia'])->name('admin.delete.media');
        //toptal
        Route::get('ordering', [MediaController::class, 'ordering'])->name('admin.ordering.media');
...
//            Route::get('coupon-lists', [UserController::class, 'couponList'])->name('convert.reward.history');
    ...
    Route::get('page-content', [FrontendController::class, 'blankpageContent'])->name('page-content');
    ...
    Route::get('/store/{slug}', [HomeController::class, 'index'])->where('path', '*')->name('store-details');
    Route::get('/store/{slug}/products', [HomeController::class, 'index'])->where('path', '*')->name('store-products');
    ...
    Route::get('home/store-categories', [FrontendController::class, 'storeCategories'])->name('front.storeCategories');
    Route::get('home/product-categories', [FrontendController::class, 'productCategories'])->name('front.productCategories');
    ...
    Route::get('home/store-products', [ProductController::class, 'productsByStoreId'])->name('product.storeProducts');
    Route::get('home/store-products-by-name', [ProductController::class, 'productsByStoreName'])->name('product.storeProductsName');
    Route::get('home/proxy-image', [ProductController::class, 'fetch']);
    Route::get('home/filter-products', [ProductController::class, 'filterByKeyWord'])->name('product.filterByKeyWord');
    Route::get('home/gallery_data', [MediaController::class, 'getMediaByIds'])->name('media.gallery');
    Route::get('home/product-details/{slug}', [ProductController::class, 'productDetails'])->name('product.details');
    Route::get('home/product-detail/{id}', [ProductController::class, 'productDetail'])->name('product.detail');
    ...
    //test
    Route::get('home/gallery/{store_code}', [FrontendController::class, 'gallery'])->name('front.gallery');
    Route::get('home/test/{store_code}', [FrontendController::class, 'test'])->name('front.test');
    //
    ...
    //driver
    Route::get('drivers/list', [DeliveryHeroController::class, 'retrieveDrivers'])->name('drivers.list');
    ...
    Route::get('home/recommend-porducts', [ProductController::class, 'recommendProducts']);
