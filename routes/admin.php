...
use App\Http\Controllers\Admin\StoresCategoryController;
    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                Route::get('get-role', [RoleController::class, 'getRoleByAjax'])->name('role.get.ajax');
                ...
                //category (This is for product category and it is only for product categories - not categories)
                ...
                Route::get('stores-categories-by-ajax', [StoresCategoryController::class, 'ajaxCategoryFilter'])->name('stores.categories.by.ajax');
                Route::get('blogs-by-ajax', [BlogController::class, 'ajaxBlogsFilter'])->name('blogs.by.ajax');

                //stores category
                Route::get('stores/categories', [StoresCategoryController::class, 'index'])->name('stores.categories')->middleware('PermissionCheck:category_read');
                Route::post('stores/store-categories', [StoresCategoryController::class, 'store'])->name('store.stores.categories')->middleware('PermissionCheck:category_create');
                Route::get('stores/edit-categories/{id}', [StoresCategoryController::class, 'edit'])->name('edit.stores.categories')->middleware('PermissionCheck:category_update');
                Route::put('stores/update-categories', [StoresCategoryController::class, 'update'])->name('update.stores.categories')->middleware('PermissionCheck:category_update');
                Route::put('stores-category-status-change', [StoresCategoryController::class, 'statusChange'])->name('stores.category.status.change')->middleware('PermissionCheck:category_update');
                Route::delete('delete/store_categories/{id}', [CommonController::class, 'delete'])->name('stores.category.delete')->middleware('PermissionCheck:category_delete');
                ...
                // Route::get('sellers/inactive', [SellerController::class, 'getInactiveSellers'])->name('sellers.inactive')->middleware('PermissionCheck:seller_read');
                ...
                //stores
                Route::get('stores', [StoreController::class, 'index'])->name('stores')->middleware('PermissionCheck:seller_read');
                Route::get('create-store', [StoreController::class, 'create'])->name('admin.store.create')->middleware('PermissionCheck:seller_create');
                Route::post('store-store', [StoreController::class, 'store'])->name('admin.store.store')->middleware('PermissionCheck:seller_create');
                Route::get('edit-store/{id}', [StoreController::class, 'edit'])->name('admin.store.edit')->middleware('PermissionCheck:seller_update');
                Route::put('update-store', [StoreController::class, 'update'])->name('admin.store.update')->middleware('PermissionCheck:seller_update');
                // Route::put('seller-status-change', [CommonController::class, 'statusChange'])->name('admin.seller.status.change')->middleware('PermissionCheck:seller_update');
                // Route::get('seller-verify/{id}/{user_id}', [StoreController::class, 'verify'])->name('admin.seller.verify')->middleware('PermissionCheck:seller_verify');
                // Route::delete('delete/seller/{id}', [CommonController::class, 'delete'])->middleware('PermissionCheck:seller_delete');
                // Route::get('seller/email-verify/{user_id}', [UserController::class, 'emailVerify'])->name('admin.seller.email.verify')->middleware('PermissionCheck:seller_update');
                ...
                Route::get('corporatepage-update', [StoreFrontController::class, 'blankPageUpdate'])->name('blankpage.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('privacypolicy-update', [StoreFrontController::class, 'privacyPolicyUpdate'])->name('privacypolicy.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('careers-update', [StoreFrontController::class, 'careersUpdate'])->name('careers.update')->middleware('PermissionCheck:footer_content_update');

                Route::get('latestnews-update', [StoreFrontController::class, 'latestNewsUpdate'])->name('latestnews.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('faq-update', [StoreFrontController::class, 'faqUpdate'])->name('faq.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('helpsupport-update', [StoreFrontController::class, 'helpSupportUpdate'])->name('helpsupport.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('ourapp-update', [StoreFrontController::class, 'ourAppUpdate'])->name('ourapp.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('termsconditions-update', [StoreFrontController::class, 'termsConditionsUpdate'])->name('termsconditions.update')->middleware('PermissionCheck:footer_content_update');
                Route::get('contactus-update', [StoreFrontController::class, 'contactUsUpdate'])->name('contactus.update')->middleware('PermissionCheck:footer_content_update');
