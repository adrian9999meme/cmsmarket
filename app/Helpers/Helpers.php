...
if (!function_exists('secure_url_mine')) {
    function secure_url_mine($name, $parameters = [], $secure = true)
    {
        return str_replace('http://', 'https://', route($name, $parameters, $secure));
    }
}
...
if (!function_exists('static_asset')) {
    ...
    {
        // Use Laravel's asset() so URLs work with php artisan serve (web root = public/)
        // and with deployed apps (ASSET_URL / APP_URL).
