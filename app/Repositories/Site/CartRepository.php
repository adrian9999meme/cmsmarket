...
class CartRepository implements CartInterface
{
    ...
    {
        if (authUser()) {
            $carts = Cart::with(['product.thumbnailMedia', 'product.stock:id,product_id,image,name,sku,current_stock',
                'product:slug,thumbnail_id,shipping_fee,user_id,price,id,thumbnail,minimum_order_quantity,is_refundable,current_stock,shipping_fee_depend_on_quantity,special_discount,special_discount_start,special_discount_end,special_discount_type,is_digital','seller:user_id,shop_name,logo'])
    ...
    public function updateCart($request)
    {
        ...
        $product_stock  = $product->stock->where('product_id', $cart_item->product_id)->first();
