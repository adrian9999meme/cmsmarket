    ...
    public function delete($table, $id){
        ...
        try {
            ...
            elseif($table == 'categories'):
                $result = DB::table($table)->where('parent_id', $id)->get();
                ...
                DB::table($table)->delete($id);
            elseif($table == 'store_categories'):
                $result = DB::table($table)->where('parent_id', $id)->get();
                foreach($result as $row){
                    StoreCategoryLanguage::where('store_category_id', $row->id)->delete();
                }
                StoreCategoryLanguage::where('store_category_id',$id)->delete();
                DB::table($table)->where('parent_id',$id)->delete();
                DB::table($table)->delete($id);
