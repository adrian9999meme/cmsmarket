...
class MediaController extends Controller
{
    ...
    {
        $sel = $request->media_id;
        $arr = explode(',',$sel);
        $image_ids = $sel ? explode(',', $sel) : $sel;
        $images = Media::find($image_ids);
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('file')){
            ...
            $size=$request->file('file')->getSize();
                     // coming file's name 
            //bkh
            $destinationPath = 'uploads/images/banners';                                      // leki/public/uploads/images image save
            if($front_type=='gallery')
            {
            ...
            if (!is_dir('public/'.$destinationPath)) {
