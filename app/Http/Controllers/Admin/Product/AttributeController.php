...
class AttributeController extends Controller
{
    ...
    public function allValues(){
        DB::beginTransaction();
        try {
            $attributeValues = $this->attribute->allAttributeValuesPaginate(get_pagination('index_form_paginate')) and $attributes = $this->attribute->all()->where('lang', \App::getLocale())->get();
            DB::commit();
