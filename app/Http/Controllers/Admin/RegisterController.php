...
{
    use SmsSenderTrait,SendMailTrait,SendNotification,ImageTrait;
...
//                    $sellerData['id'] = 1;
            ...
            if($request->user_type== 'delivery_hero') {
                DB::table('delivery_heroes')->insert([
                    'user_id' => $sellerData->id,
                    'driving_licence' => $request->driving_license,
                    'country_id' => 232,
                    'state_id' => 23,
