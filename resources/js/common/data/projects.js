//import Images
import companies01 from "../../../images/companies/img-1.png";
import companies02 from "../../../images/companies/img-2.png";
import companies03 from "../../../images/companies/img-3.png";
import companies04 from "../../../images/companies/img-4.png";
import companies05 from "../../../images/companies/img-5.png";
import companies06 from "../../../images/companies/img-6.png";
...
const projects = [
  {
    ...
    files: [
      { name: "Lekit Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Lekit Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Lekit Logo.Zip", size: "2.02 MB", link: "#" },
  ...
  },
  {
    ...
    team: [
      ...
      { id: 14, img: "Null", name: "R", color: "warning", fullname: "Rony Candles" },
    ],
  },
  {
    id: 7,
    ...
    commentsCount: 185,
    team: [
      { id: 15, img: "Null", name: "L", color: "pink", fullname: "Lony Mackay" },
  ...
  },
  {
    ...
    team: [
      ...
      { id: 19, img: "Null", name: "A", color: "success", fullname: "Aeffrey Walker" },
  ...
  },
  {
    ...
    team: [
      {
        id: 21, img: avatar4, fullname: "Janice Cole", skills: [
          { id: 1, name: "Frontend" },
          { id: 2, name: "UI" },
        ],
      },
      {
        id: 22, img: avatar5, fullname: "Steve Foster",
        skills: [{ id: 1, name: "UI/UX" }],
      },
      {
        id: 23, img: "Null", name: "A", color: "success", fullname: "Aeffrey Walker",
        skills: [{ id: 1, name: "Backend" }],
      },
      {
        id: 24, img: avatar2, fullname: "Daniel Candles",
        skills: [
          { id: 1, name: "Frontend" },
          { id: 2, name: "UI" },
        ],
  ...
  },
  {
    ...
    commentsCount: 214,
    team: [
      { id: 25, img: "Null", name: "L", color: "pink", fullname: "Lony Mackay" },
  ...
  },
  {
    ...
    team: [
      {
        id: 27, img: avatar4, fullname: "Janice Cole", skills: [
          { id: 1, name: "Frontend" },
          { id: 2, name: "UI" },
        ],
      },
      {
        id: 28, img: "Null", name: "A", color: "success", fullname: "Aeffrey Walker",
        skills: [{ id: 1, name: "Backend" }],
      },
      {
        id: 29, img: avatar5, fullname: "Steve Foster",
        skills: [{ id: 1, name: "UI/UX" }],
      },
    ],
    startDate: "08 Sept, 2019",
