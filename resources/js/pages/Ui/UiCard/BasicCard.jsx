    ...
    return (
        <React.Fragment>
            ...
            <Row>
                <Col md={6} xl={3}>
                    <Card>
                        <CardImg top className="img-fluid" src={img1} alt="Lekit" />
                        <CardBody>
                ...
                <Col md={6} xl={3}>
                    <Card>
                        <CardImg top className="img-fluid" src={img2} alt="Lekit" />
                        <CardBody>
                            <CardTitle className="mt-0">Card title</CardTitle>
                            <CardText>
                                Some quick example text to build on the card title and make
                ...
                <Col md={6} xl={3}>
                    <Card>
                        <CardImg top className="img-fluid" src={img3} alt="Lekit" />
                        <CardBody>
                            <CardText>
                                Some quick example text to build on the card title and make
                                up the bulk of the card&apos;s content.
                ...
                <Col md={6} xl={3}>
                    <Card>
                        ...
                        <CardImg className="img-fluid" src={img4} alt="Lekit" />
                        <CardBody>
                            <CardText>
                                Some quick example text to build on the card title and make
                                up the bulk of the card&apos;s content.
