...
import DumbbellChart from "../AllCharts/apex/dumbbell";
import RangeAreaChart from "../AllCharts/apex/RangeAreaChart";
import DumbbellTimplineChart from "../AllCharts/apex/DumbbellTimplineChart";
...
const Apexchart = () => {
  ...
  //meta title
  document.title = "Apex Charts | LEKIT Ltd";
        ...
        <div className="container-fluid">
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <DumbbellChart dataColors='["--bs-primary", "--bs-success"]' />
                </CardBody>
              </Card>
            </Col>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4"> Dumbbell Timeline Chart (Horizontal) </CardTitle>
                  <DumbbellTimplineChart dataColors='["--bs-primary", "--bs-success"]' />
                </CardBody>
              </Card>
            </Col>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4"> Funnel Charts </CardTitle>
