...
const EcommerceProductDetail = (props) => {
  ...
  //meta title
  document.title = "Product Details | LEKIT Ltd";
  ...
  const { product, productComments } = useSelector(ecommerceSelector);
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
                    ...
                    <Row>
                          ...
                          <Row>
                              ...
                              <Nav className="flex-column" pills>
                                <NavItem>
                                  <NavLink className={classnames({ active: activeTab === "1", })} onClick={() => { toggleTab("1"); }}>
                                    <img src={product.subImage[0]} alt=""
                                      onClick={() => {
                                ...
                                <NavItem>
                                  <NavLink className={classnames({ active: activeTab === "2", })} onClick={() => { toggleTab("2"); }}>
                                    <img src={product.subImage[1]} alt=""
                                      onClick={() => {
                                ...
                                <NavItem>
                                  <NavLink className={classnames({ active: activeTab === "3", })} onClick={() => { toggleTab("3"); }}>
                                    <img src={product["subImage"][2]} alt=""
                                      onClick={() => {
                            ...
                            <Col md={7} sm={9} className="offset-md-1 col-8">
                              <TabContent activeTab={activeTab}>
                                <TabPane tabId="1">
                                  <div>
                                    <img src={product.image} alt="" id="expandedImg1" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="2">
                                  <div>
                                    <img src={product.image} id="expandedImg2" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="3">
                                  <div>
                                    <img src={product.image} id="expandedImg3" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                                <TabPane tabId="4">
                                  <div>
                                    <img src={product.image} id="expandedImg4" alt="" className="img-fluid mx-auto d-block" />
                                  </div>
                                </TabPane>
                              </TabContent>
                              <div className="text-center">
                                <Button type="button" color="primary" className="btn mt-2 me-1">
                                  <i className="bx bx-cart me-2" /> Add to cart
                                </Button>
                                <Button type="button" color="success" className="ms-1 btn mt-2">
                                  <i className="bx bx-shopping-bag me-2" /> Buy now
                                </Button>
                              </div>
                            </Col>
                          </Row>
                      ...
                      <Col xl="6">
                        <div className="mt-4 mt-xl-3">
                          <Link to="#" className="text-primary">{product.category}</Link>
                              ...
                              (product.colorOptions || [])?.map((option, i) => (
                                <Link to="#" className="active" key={i}>
                                  <div className="product-color-item border rounded">
                                    <img src={option.image} alt="" className="avatar-md" />
                                  </div>
                                  <p>{option.color}</p>
                                </Link>
                              ))}
          ...
          <RecentProducts productDetail={product || []} />
        </Container>
      </div>
    </React.Fragment>
  );
